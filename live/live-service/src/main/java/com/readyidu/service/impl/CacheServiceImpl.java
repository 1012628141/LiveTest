...
//        cachePool = new JedisPool(new JedisPoolConfig(), ConfigSettings.getProperty("redis_host", "localhost"), NumberUtils.toInt(
//                ConfigSettings.getProperty("redis_port"), 6379), NumberUtils.toInt(ConfigSettings.getProperty("redis_timeout"), 3000));
//    }
...
//            cache.auth(ConfigSettings.getProperty("redis_pwd", ""));
