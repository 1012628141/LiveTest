                        ...
                        $.ajax(
                            {
                                ...
                                dataType: "json",
                                data: JSON.stringify({"channelId": id, "sourceId": sid}),
                            ...
                            $.ajax(
                                {
                                    ...
                                    data: JSON.stringify({"channelId": id, "sourceUri": value}),
                                    contentType: "application/json; charset=utf-8",
                                    dataType: "json",
                                    success: function (data) {
                                        var result = JSON.parse(data);
                            ...
                            $.ajax(
                                {
                                    ...
                                    contentType: "application/json; charset=utf-8",
                                    dataType: "json",
                                    data: JSON.stringify({"channelId": id, "typeId": value}),
                                    success: function (data) {
                                        var result = JSON.parse(data);
                                        if (result.code === 200) {
                        ...
                        $.ajax(
                            {
                                ...
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: JSON.stringify({"channelId": id}),
                                success: function (data) {
                                    var result = JSON.parse(data);
                                    if (result.code === 200) {
