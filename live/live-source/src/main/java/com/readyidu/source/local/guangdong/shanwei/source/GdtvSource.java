package com.readyidu.source.local.guangdong.shanwei.source;
...
public class GdtvSource extends Source {
    ...
    protected String source() {
        ...
        if (NullUtil.isNullObject(cacheSource)) {
            String gdtv = null;
            switch (sourceId) {
                case SourceConstants.SOURCE_GDTV_SHANWEI1:
                    gdtv = HttpUtil.httpGet("http://www.gdtv.cn/m2o/channel/channel_info.php?id=81");
                    break;
                default:
                    break;
            }
