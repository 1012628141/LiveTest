...
public class CNTVSource extends Source {
    ...
    protected String source() {
        ...
        String cntvJs = null;
        switch (sourceId) {
            case SourceConstants.SOURCE_CNTV_XMTV1:
                cntvJs = "http://vdn.live.cntv.cn/api2/liveHtml5.do?channel=pa://cctv_p2p_hdxiamen1&client=html5";
                break;
            case SourceConstants.SOURCE_CNTV_XMTV2:
                cntvJs = "http://vdn.live.cntv.cn/api2/liveHtml5.do?channel=pa://cctv_p2p_hdxiamen2&client=html5";
                break;
            case SourceConstants.SOURCE_CNTV_XMTV3:
                cntvJs = "http://vdn.live.cntv.cn/api2/liveHtml5.do?channel=pa://cctv_p2p_hdxiamen3&client=html5";
                break;
            case SourceConstants.SOURCE_CNTV_XMTV4:
                cntvJs = "http://vdn.live.cntv.cn/api2/liveHtml5.do?channel=pa://cctv_p2p_hdxiamen4&client=html5";
                break;
            default:
                break;
        }
