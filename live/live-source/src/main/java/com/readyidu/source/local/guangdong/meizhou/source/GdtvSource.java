package com.readyidu.source.local.guangdong.meizhou.source;
...
public class GdtvSource extends Source {
    ...
    protected String source() {
        ...
        if (NullUtil.isNullObject(cacheSource)) {
            String gdtv = null;
            switch (sourceId) {
                case SourceConstants.SOURCE_GDTV_MEIZHOU1:
                    gdtv = HttpUtil.httpGet("http://www.gdtv.cn/m2o/channel/channel_info.php?id=66");
                    break;
                default:
                    break;
            }
            ...
            if (gdtvArray != null && gdtvArray.size() > 0) {
                ...
                if (gdtvObject != null) {
                    ...
                    CacheUtil.set(CACHE_NAME + sourceId, HeaderUtil.addHeader(m3u8, header), CHACHE_TIMEOUT);
