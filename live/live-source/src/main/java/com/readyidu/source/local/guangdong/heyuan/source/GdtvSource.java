package com.readyidu.source.local.guangdong.heyuan.source;
...
public class GdtvSource extends Source {
    ...
    protected String source() {
        ...
        if (NullUtil.isNullObject(cacheSource)) {
            String gdtv = null;
            switch (sourceId) {
                case SourceConstants.SOURCE_GDTV_HEYUAN1:
                    gdtv = HttpUtil.httpGet("http://www.gdtv.cn/m2o/channel/channel_info.php?id=67");
                    break;
                default:
                    break;
            }
