package com.readyidu.source.local.zhejiang.shengzhou.source;
...
public class CztvSource extends Source {
    ...
    protected String source() {
        ...
        switch (sourceId) {
            case SourceConstants.SOURCE_CZTV_SZTTKK1:
                sourceData = HttpUtil.httpGet("http://d.cztvcloud.com/config/live/68301.json");
                break;
            default:
                break;
        }
